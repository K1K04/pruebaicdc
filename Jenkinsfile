            ...
            stages {
                stage ('Despliegue flaskapp'){
                    steps{
                        ...
                        sh 'ssh -p 4444 -o StrictHostKeyChecking=no debian@popeye.kiko4da.fun "cd pruebaicdc && git pull && docker-compose down -v && docker pull kiko4/flask-app:latest && docker-compose up -d"'
                        }
                    }
                }
            }
